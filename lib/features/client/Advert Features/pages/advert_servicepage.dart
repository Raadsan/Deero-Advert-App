                                  ...
                                  children: [
                                    ...
                                    if (services.isNotEmpty &&
                                        ...
                                        services[_selectedIndex]
                                            ...
                                            .isNotEmpty)
                                      ...(() {
                                        final packages = List<Packages>.from(
                                          services[_selectedIndex].packages!,
                                        );
                                        packages.sort(
                                          (a, b) => (a.price ?? 0).compareTo(
                                            b.price ?? 0,
                                          ),
                                        );
                              ...
                              Expanded(
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    double bonusDiscount = isBonusAvailable
          ...
          child: Padding(
            ...
            child: Builder(
              builder: (context) {
                ...
                double bonusDiscount = isBonusAvailable
                    ? (widget.package.price ?? 0).toDouble() / 2
                    : 0;
                double flexDiscount = 0;
                ...
                final double appliedDiscount = bonusDiscount > flexDiscount
                    ...
                    : flexDiscount;
                final double finalPrice =
                    (widget.package.price ?? 0) - appliedDiscount;
